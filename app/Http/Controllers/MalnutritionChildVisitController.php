...
class MalnutritionChildVisitController extends Controller
{
    ...
    public function MalnutritionChildVisitReport(Request $request){
        ...
        ->join('malnutrition_child_visits as mwv', 'mwv.id', '=', 'mo.medicine_orderable_id')
        ->join('child_treatment_programs as mtp', 'mtp.id', '=', 'mwv.programs_id')
        ...
        ->select(
            ...
            'mr.gender as gender',
            'mtp.program_type as p_type'
        )
        ->where('mo.is_aprroved', true)
        ->where('mo.medicine_orderable_type', 'LIKE', '%MalnutritionChild%')
        ->get();
            ...
            $newCells = [
                ...
                WriterEntityFactory::createCell($result->p_type),
